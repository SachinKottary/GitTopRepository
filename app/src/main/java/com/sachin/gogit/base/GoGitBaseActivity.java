...
import com.sachin.gogit.interfaces.FragmentInteractionListener;
import com.sachin.gogit.utils.FragmentUtils;

/**
 *  Base class for all the activities, contains methods related to fragment transactions
 */
public class GoGitBaseActivity extends AppCompatActivity implements FragmentInteractionListener {
